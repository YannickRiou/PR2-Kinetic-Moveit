...
private:
  void initFields()
  {
    ...
    location.init(this, "location");
    inspect.init(this, "inspect");
    ingredient.init(this, "ingredient");
    asJson.init(this, "asJson");
  }
public:
  // No description given
  FeatureStructureEntry<INT64> timestamp;
  // No description given
  FeatureStructureEntry<std::string> location;
  // No description given
  FeatureStructureEntry<std::string> inspect;
  // No description given
  FeatureStructureEntry<std::string> ingredient;
  // No description given
  FeatureStructureEntry<std::string> asJson;
